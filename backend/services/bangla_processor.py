...
SPELLING_VARIATIONS: dict[str, str] = {
    ...
    # relational slang normalization
    "bondhu": "bondhu", "bondu": "bondhu", "bondho": "bondhu",
    "dost": "dost", "dosth": "dost",
    "mama": "mama", "mamu": "mama",
    "kaka": "kaka", "kaaka": "kaka",
    "chacha": "chacha", "chaacha": "chacha",
    "masst": "mast", "masth": "mast", "maast": "mast",
}
...
BANGLISH_TO_BANGLA: dict[str, str] = {
    ...
    # --- Extended relational / slang / casual words ---
    "bondhu": "বন্ধু",
    "dost": "বন্ধু",
    "dosth": "বন্ধু",
    "mama": "মামা",
    ...
    # --- Common casual / daily-life Banglish words ---
    "aaj": "আজ",
    "aaje": "আজকে",
    "ajke": "আজকে",
    "kal": "কাল",
    ...
    "bhulam": "ভুলাম",
    "bhulechi": "ভুলেছি",
    "bhule gelam": "ভুলে গেলাম",
    "bhule gesi": "ভুলে গেসি",
    "jhamelai": "ঝামেলায়",
    "jhamela": "ঝামেলা",
    "stress": "মানসিক চাপ",
    "tension": "টেনশন",
...
BANGLISH_SLANG_TO_ENGLISH: dict[str, str] = {
    ...
    # Extended casual / relational
    "bondhu": "friend buddy",
    "dost": "friend buddy",
    "dosth": "friend buddy",
    "mama": "uncle maternal uncle",
    "kaka": "uncle paternal uncle",
    "chacha": "uncle",
    "bro": "brother bro",
    "sis": "sister",
    "dada": "elder brother",
    ...
    "eta": "this",
    "ota": "that",
    "mast": "great awesome cool excellent",
    "masth": "great awesome cool excellent",
    "laglo": "felt seemed",
    "shotti": "really truly",
    "shotti darun": "really wonderful truly amazing",
    "cholbe": "will do fine okay",
    "hobe": "will be will happen",
    "sobai": "everyone",
    "priyo": "dear beloved",
}
...
def _is_banglish(text: str) -> bool:
    ...
    bangla_digraphs = [
        ...
        r'\bbondhu\b', r'\bdost\b', r'\bmama\b', r'\bkaka\b',
        r'\bmast\b', r'\blaglo\b', r'\beta\b', r'\bshotti\b',
    ]
